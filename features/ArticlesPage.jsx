      ...
      <Page>
        <Wrap>
          ...
          <ContentOuter>
            <ContentInner>
              <Row
                title="How Sohra Peak Capital Partners Outperformed the S&P 500 in Q3 2023"
                description="Learn about how to research about MEV bots so you can eventually build your own."
                date="Oct 11, 2022 | By HFVision"
